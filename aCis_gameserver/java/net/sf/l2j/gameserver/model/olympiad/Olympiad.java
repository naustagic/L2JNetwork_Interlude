...
public class Olympiad
{
	...
	private static final String GET_EACH_CLASS_LEADER_CURRENT = "SELECT characters.char_name from olympiad_nobles, characters " + "WHERE characters.obj_Id = olympiad_nobles.char_id AND olympiad_nobles.class_id = ? " + "AND olympiad_nobles.competitions_done >= 5 " + "ORDER BY olympiad_nobles.olympiad_points DESC, olympiad_nobles.competitions_done DESC LIMIT 10";
	...
	private void load()
	{
		...
		synchronized (this)
		{
			...
			_log.info("Olympiad System: " + numDays + " days, " + numHours + " hours and " + numMins + " mins. until period ends");
			...
			if (_period == 0)
			{
				...
				_log.info("Olympiad System: Next weekly change in " + numDays1 + " days, " + numHours1 + " hours and " + numMins1 + " mins.");
			}
		}
	...
	public void olympiadEnd(Player player)
	{
		...
		player.sendPacket(new CreatureSay(0, Say2.PARTYROOM_COMMANDER, "  Olympiad", "Date of new heroes at: " + days + " days, " + hours + " hours, " + minutes + " minutes."));
	}
