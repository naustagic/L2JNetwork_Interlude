...
public class WeddingManagerNpc extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("GoToLove"))
		{
			...
			if (partner.isInFunEvent() || partner.isInJail() || partner.isInOlympiadMode() || partner.isInDuel() || partner.isFestivalParticipant() || (partner.isInParty() && partner.getParty().isInDimensionalRift()) || partner.inObserverMode() || partner.isAio())
			{
	...
	public static void justMarried(Player requester, Player partner)
	{
		...
		if (partner.getAppearance().getSex() == requester.getAppearance().getSex())
			Broadcast.announceToOnlinePlayers("Congratulations to " + requester.getName() + " and " + partner.getName() + "! They have been married. It was a wonderful same-sex marriage!", true);
		else
			Broadcast.announceToOnlinePlayers("Congratulations to " + requester.getName() + " and " + partner.getName() + "! They have been married. It was a wonderful marriage!", true);
	}
