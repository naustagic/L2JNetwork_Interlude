...
public class VillageMaster extends Folk
{
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		else if (command.startsWith("Subclass"))
		{
			...
			{
				player.sendMessage("You can not change sub class while registered at TvT");
				return;
			}
			...
			{
				player.sendMessage("You cannot do this action while your character is in flag mode.");
				return;
			}
			...
			switch (cmdChoice)
			{
				...
				case 1: // Add Subclass - Initial
					...
					if (player.getSubClasses().size() >= 5)
					{
