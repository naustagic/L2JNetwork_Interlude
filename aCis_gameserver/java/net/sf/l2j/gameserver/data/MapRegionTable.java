...
public class MapRegionTable
{
	...
	public Location getLocationToTeleport(Creature character, TeleportType teleportType)
	{
		...
		// Check if player is in arena.
		final L2FlagZone flagarena = ZoneManager.getInstance().getZone(player, L2FlagZone.class);
		if (flagarena != null)
			return flagarena.getSpawnLoc();
		
		// Check if player is in solo.
		final L2SoloZone solo = ZoneManager.getInstance().getZone(player, L2SoloZone.class);
		if (solo != null)
