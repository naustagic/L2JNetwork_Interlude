...
public class AioMenu implements IVoicedCommandHandler
{
	...
	public static void mainHtml(Player activeChar, int time)
	{
		...
		{
			html.append("<br><br>");
			html.append("<button value=\"Towns\" action=\"bypass -h aiopanel panelteleport\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
	...
	public static void bypass(Player activeChar, String command, StringTokenizer st)
	{
		if (command.equals("panelteleport"))
		{
			...
			{
				html.append("<br><br>");
				html.append("<button value=\"Giran\" action=\"bypass -h aiopanel teleportTo 1040\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Goddard\" action=\"bypass -h aiopanel teleportTo 1039\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Rune\" action=\"bypass -h aiopanel teleportTo 1041\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Aden\" action=\"bypass -h aiopanel teleportTo 1037\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Dion\" action=\"bypass -h aiopanel teleportTo 6\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Gludio\" action=\"bypass -h aiopanel teleportTo 1099\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Gludin\" action=\"bypass -h aiopanel teleportTo 5\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Heine\" action=\"bypass -h aiopanel teleportTo 1036\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Oren\" action=\"bypass -h aiopanel teleportTo 1038\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<button value=\"Schuttgart\" action=\"bypass -h aiopanel teleportTo 1035\" width=90 height=22 back=\"SS_L2jNetwork.smallb_down\" fore=\"SS_L2jNetwork.smallb\">");
				html.append("<br><br>");
			}
			else
			{
