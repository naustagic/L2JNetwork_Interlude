...
public final class RequestRestart extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			player.sendMessage("You can not restart when you registering in TvT Event.");
			sendPacket(RestartResponse.valueOf(false));
			return;
		}
		...
		{
			player.sendMessage("You cannot restart inside this zone.");
			sendPacket(RestartResponse.valueOf(false));
			return;
		}
		...
		{
			player.sendMessage("You cannot restart while you have been registered for olympiad match.");
			sendPacket(RestartResponse.valueOf(false));
			return;
		}
