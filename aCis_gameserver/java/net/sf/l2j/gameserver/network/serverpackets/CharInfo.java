...
public class CharInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		boolean solozone = _activeChar.isInSoloZone();
		writeC(0x03);
		...
		if (solozone && Config.SOLO_ZONE_HIDE_CLANS || _activeChar.isInsideZone(ZoneId.FLAG))
		{
			writeD(0);
			writeD(0);
			writeD(0);
		...
		if (_activeChar.getTeam() == Team.BLUE)
			writeC(0x01); // team circle around feet 1= Blue, 2 = red
		else if (_activeChar.getTeam() == Team.RED)
		...
		if (Config.SOLO_ZONE_HIDE_CLANS && solozone || _activeChar.isInsideZone(ZoneId.FLAG))
		{
			writeD(0);
			writeD(0);
		}
