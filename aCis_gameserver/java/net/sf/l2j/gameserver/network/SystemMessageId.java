...
public final class SystemMessageId
{
	...
	/**
	 * ID: 1517<br>
	 * Message: Failed in Blessed Enchant. The enchant value of the item became 4.
	 */
	...
	/**
	 * ID: 2100<br>
	 * Message: Cursed weapon owners are not allowed to participate.
	 */
	public static final SystemMessageId CURSED_WEAPON_RESTRICTED_FOR_PARTICIPATE;
	
	/**
	 * ID: 2101<br>
	 * Message: Olympiad participants can't register.
	 */
	public static final SystemMessageId OLYMPIAD_RESTRICTED_FOR_PARTICIPATE;
	
	/**
	 * ID: 2102<br>
	 * Message: Chaotic players are not allowed to participate.
	 */
	public static final SystemMessageId KARMA_RESTRICTED_FOR_PARTICIPATE;
	
	/**
	 * ID: 2103<br>
	 * Message: Sorry the event is full! Maximum of $s1 player are allowed in one team.
	 */
	public static final SystemMessageId CANT_PARTICIPATE_EVENT_TEAM_IS_FULL_S1;
	
	/**
	 * ID: 2104<br>
	 * Message: Only players from level $s1 to level $s2 are allowed to participate.
	 */
	public static final SystemMessageId CANT_PARTICIPATE_EVENT_TEAM_LEVEL_S1_TO_S2;
	
	/**
	 * ID: 2105<br>
	 * Message: You are on the registration list now.
	 */
	public static final SystemMessageId PARTICIPATE_IS_DONE;
	
	/**
	 * ID: 2106<br>
	 * Message: You are not longer on the registration list.
	 */
	public static final SystemMessageId PARTICIPATE_IS_CANCELLED;
	...
	static
	{
		...
		CURSED_WEAPON_RESTRICTED_FOR_PARTICIPATE = new SystemMessageId(2100);
		OLYMPIAD_RESTRICTED_FOR_PARTICIPATE = new SystemMessageId(2101);
		KARMA_RESTRICTED_FOR_PARTICIPATE = new SystemMessageId(2102);
		CANT_PARTICIPATE_EVENT_TEAM_IS_FULL_S1 = new SystemMessageId(2103);
		CANT_PARTICIPATE_EVENT_TEAM_LEVEL_S1_TO_S2 = new SystemMessageId(2104);
		PARTICIPATE_IS_DONE = new SystemMessageId(2105);
		PARTICIPATE_IS_CANCELLED = new SystemMessageId(2106);
