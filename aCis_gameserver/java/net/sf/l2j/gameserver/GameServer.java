...
import net.sf.l2j.gameserver.votesystem.OnlinePoint;
...
public class GameServer
{
	...
	public GameServer() throws Exception
	{
		...
		StringUtil.printSection("L2jNetwork Initializing");
		...
		System.out.println("Online Point Enabled");
		ThreadPool.scheduleAtFixedRate(OnlinePoint.getInstance(), Config.ONLINE_INTERVAL * 60 * 1000, Config.ONLINE_INTERVAL * 60 * 1000);
		...
		StringUtil.printSection("L2jNetwork Login");
