...
public class L2SkillTeleport extends L2Skill
{
	...
	public void useSkill(Creature activeChar, WorldObject[] targets)
	{
		if (activeChar instanceof Player)
		{
			...
			if (activeChar.isAfraid() || ((Player) activeChar).isInOlympiadMode() || ((Player) activeChar).isInFunEvent() || ((Player) activeChar).isAio() || ((Player) activeChar).isInsideZone(ZoneId.PVP) || ((Player) activeChar).isInsideZone(ZoneId.FLAG))
				return;
		}
