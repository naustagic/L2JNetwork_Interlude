...
public final class Config
{
	...
	public static final String SOLO_FILE = "./config/customs/solo.properties";
	...
	// vote Manager Single Configs
	public static String L2NETWORK_ID;
	public static String L2TOPZONE_APIKEY;
	public static String L2TOPZONE_ID;
	public static String L2HOPZONE_APIKEY;
	public static String[] VOTE_MANAGER_REWARD;
	
	/** TvT Event section */
	public static boolean TVT_EVENT_ENABLED;
	public static String[] TVT_EVENT_SCHEDULER_TIMES;
	public static int TVT_EVENT_PARTICIPATION_TIME;
	public static int TVT_EVENT_RUNNING_TIME;
	public static int TVT_EVENT_TELEPORT_DELAY;
	public static int TVT_EVENT_RESPAWN_DELAY;
	public static int TVT_EVENT_PARTICIPATION_NPC_ID;
	public static Location TVT_EVENT_PARTICIPATION_NPC_LOCATION;
	public static boolean TVT_EVENT_NPC_DIALOGUE_HTML_ENABLE;
	public static int[][] TVT_EVENT_PARTICIPATION_FEE;
	public static int TVT_EVENT_MINIMAL_PLAYERS_IN_TEAM;
	public static int TVT_EVENT_MAXIMAL_PLAYERS_IN_TEAM;
	public static byte TVT_EVENT_MIN_LVL;
	public static byte TVT_EVENT_MAX_LVL;
	public static String TVT_EVENT_TEAM_BLUE_NAME;
	public static Location TVT_EVENT_TEAM_BLUE_SPAWN_LOCATION;
	public static Location TVT_EVENT_TEAM_BLUE_BACK_LOCATION;
	public static String TVT_EVENT_TEAM_RED_NAME;
	public static Location TVT_EVENT_TEAM_RED_SPAWN_LOCATION;
	public static Location TVT_EVENT_TEAM_RED_BACK_LOCATION;
	public static boolean TVT_EVENT_REMOVE_BUFFS;
	public static boolean TVT_EVENT_HEAL_PLAYERS;
	public static boolean TVT_COUNT_KILLS_PVP;
	public static boolean TVT_KILLS_REWARD_ENABLED;
	public static int[][] TVT_KILLS_REWARD;
	public static int[][] TVT_EVENT_REWARDS;
	public static int TVT_EVENT_KILLS_REQUIRED;
	public static boolean TVT_EVENT_TARGET_TEAM_MEMBERS_ALLOWED;
	public static boolean TVT_EVENT_SCROLL_ALLOWED;
	public static boolean TVT_EVENT_POTIONS_ALLOWED;
	public static boolean TVT_EVENT_SUMMON_BY_ITEM_ALLOWED;
	public static List<Integer> TVT_EVENT_DOOR_IDS;
	...
	/** Solo zone settings */
	public static boolean SOLO_ZONE_RESTRICT_SAMEIP;
	public static boolean SOLO_ZONE_RESPAWN;
	public static boolean SOLO_ZONE_MESSAGES;
	public static String[] SOLO_ZONE_RESPAWNS;
	public static String[] SOLO_ZONE_EXIT_LOCATION;
	public static String[] SOLO_ZONE_RESTRICTED_CLASSES;
	public static boolean SOLO_ZONE_SCHEDULED;
	public static String[] SOLO_ZONE_HOURS;
	public static int SOLO_ZONE_DURATION;
	public static boolean SOLO_ZONE_NOBLESS;
	public static boolean SOLO_ZONE_CLEANSE;
	public static boolean SOLO_ZONE_HEAL;
	public static boolean SOLO_ZONE_DISABLE_TRADES;
	public static boolean SOLO_ZONE_DISABLE_RESTART;
	public static boolean SOLO_ZONE_HIDE_CLANS;
	public static int SOLO_ZONE_KILLS_DURATION;
	public static String[] SOLO_ZONE_ITEMS_REWARD;
	
	/** PC Bang Item */
	public static Map<Integer, Integer> ONLINE_REWARD = new HashMap<>();
	public static int ONLINE_INTERVAL;
	
	/** Vote Manager API */
	public static int API_REWARD_ID;
	public static int API_REWARD_COUNT;
	public static String SERVERID_KEYTOPZONE;
	...
	public static String VOTES_SITE_BRASIL_LINK_BRA;
	...
	/** New Attack Movement Check */
	public static boolean NEW_AI_MOVING_ATTACK_CHECK;
	public static int NEW_AI_MOVING_ATTACK_CHECK_RADIUS;
	...
	public static int CLIENT_PACKET_QUEUE_MAX_OVERFLOWS_PER_MIN = 20; // default 1
	...
	/**
	 * Loads solo zone settings.
	 */
	private static final void loadSoloZone()
	{
		final ExProperties soloZone = initProperties(SOLO_FILE);
		SOLO_ZONE_RESTRICT_SAMEIP = soloZone.getProperty("RestrictRewardForSameIp", true);
		SOLO_ZONE_RESPAWN = soloZone.getProperty("RespawnInsideSoloZone", true);
		SOLO_ZONE_SCHEDULED = soloZone.getProperty("EnableScheduled", true);
		SOLO_ZONE_HOURS = soloZone.getProperty("OpeningHours", "").split(",");
		SOLO_ZONE_DURATION = soloZone.getProperty("Duration", 60);
		SOLO_ZONE_RESTRICTED_CLASSES = soloZone.getProperty("RestrictedClasses", "15,16,17,29,30,42,43,97,98,105,112,135,136,116").split(",");
		SOLO_ZONE_NOBLESS = soloZone.getProperty("Nobless", true);
		SOLO_ZONE_CLEANSE = soloZone.getProperty("Cleanse", true);
		SOLO_ZONE_HEAL = soloZone.getProperty("Heal", true);
		SOLO_ZONE_MESSAGES = soloZone.getProperty("EnterPlayersNumberMessage", true);
		SOLO_ZONE_DISABLE_TRADES = soloZone.getProperty("DisableTrades", true);
		SOLO_ZONE_DISABLE_RESTART = soloZone.getProperty("DisableRestart", true);
		SOLO_ZONE_RESPAWNS = soloZone.getProperty("Respawns", "-8779,14601,-4902").split(";");
		SOLO_ZONE_EXIT_LOCATION = soloZone.getProperty("ExitLocation", "-8779,14601,-4902").split(",");
		SOLO_ZONE_KILLS_DURATION = soloZone.getProperty("RestrictRewardForRecentlyKilledPlayer", 60);
		// hides
		SOLO_ZONE_HIDE_CLANS = soloZone.getProperty("HideClans", true);
		// Rewards
		SOLO_ZONE_ITEMS_REWARD = soloZone.getProperty("ItemsQuantityReward", "57,5000").split(";");
	}
	...
	private static final void loadCustoms()
	{
		...
		USE_CUSTOM_CAMERA = customs.getProperty("UseCustomCamera", false);
		...
		RESTART_BY_TIME_OF_DAY = customs.getProperty("EnableRestartSystem", false);
		RESTART_SECONDS = customs.getProperty("RestartSeconds", 360);
		RESTART_INTERVAL_BY_TIME_OF_DAY = customs.getProperty("RestartByTimeOfDay", "20:00").split(",");
	}
	...
	{
		final ExProperties events_custom = initProperties(TVT_FILE);
		// TvT Event
		TVT_EVENT_ENABLED = events_custom.getProperty("TvTEventEnabled", false);
		TVT_EVENT_SCHEDULER_TIMES = events_custom.getProperty("TvTEventSchedulerTime", "20:00").split(",");
		TVT_EVENT_PARTICIPATION_TIME = events_custom.getProperty("TvTEventParticipationTime", 10);
		TVT_EVENT_RUNNING_TIME = events_custom.getProperty("TvTEventRunningTime", 15);
		TVT_EVENT_TELEPORT_DELAY = events_custom.getProperty("TvTEventTeleportDelay", 5);
		TVT_EVENT_RESPAWN_DELAY = events_custom.getProperty("TvTEventRespawnDelay", 5);
		TVT_EVENT_PARTICIPATION_NPC_ID = events_custom.getProperty("TvTEventParticipationNpcId", 10010);
		TVT_EVENT_PARTICIPATION_NPC_LOCATION = parseLocation(events_custom.getProperty("TvTEventParticipationNpcLocation", ""));
		
		TVT_EVENT_NPC_DIALOGUE_HTML_ENABLE = events_custom.getProperty("TvTEventNpcDialogieHtmlEnable", true);
		
		TVT_EVENT_PARTICIPATION_FEE = parseItemsList(events_custom.getProperty("TvTEventParticipationFee", "0,0"));
		
		TVT_EVENT_MINIMAL_PLAYERS_IN_TEAM = events_custom.getProperty("TvTEventMinPlayersInTeams", 1);
		TVT_EVENT_MAXIMAL_PLAYERS_IN_TEAM = events_custom.getProperty("TvTEventMaxPlayersInTeams", 20);
		...
		TVT_EVENT_TEAM_BLUE_NAME = events_custom.getProperty("TvTEventTeamBlueName", "Team #1");
		TVT_EVENT_TEAM_BLUE_SPAWN_LOCATION = parseLocation(events_custom.getProperty("TvTEventTeamBlueSpawnLocation", ""));
		TVT_EVENT_TEAM_BLUE_BACK_LOCATION = parseLocation(events_custom.getProperty("TvTEventTeamBlueBackLocation", ""));
		
		TVT_EVENT_TEAM_RED_NAME = events_custom.getProperty("TvTEventTeamRedName", "Team #2");
		TVT_EVENT_TEAM_RED_SPAWN_LOCATION = parseLocation(events_custom.getProperty("TvTEventTeamRedSpawnLocation", ""));
		TVT_EVENT_TEAM_RED_BACK_LOCATION = parseLocation(events_custom.getProperty("TvTEventTeamRedBackLocation", ""));
		
		TVT_EVENT_REMOVE_BUFFS = events_custom.getProperty("TvTEventRemoveBuffs", true);
		TVT_EVENT_HEAL_PLAYERS = events_custom.getProperty("TvTHealPlayersEnable", false);
		TVT_COUNT_KILLS_PVP = events_custom.getProperty("TvTCountKillsPvP", false);
		TVT_KILLS_REWARD_ENABLED = events_custom.getProperty("TvTKillsRewardEnable", false);
		TVT_KILLS_REWARD = parseItemsList(events_custom.getProperty("TvTKillsReward", "57,100;57,1000;57,10000"));
		TVT_EVENT_REWARDS = parseItemsList(events_custom.getProperty("TvTEventReward", "57,100"));
		TVT_EVENT_KILLS_REQUIRED = events_custom.getProperty("TvTEventKillsRequired", 0);
		...
		TVT_EVENT_DOOR_IDS = parseDoorsList(events_custom.getProperty("TvTEventDoorsCloseOpenOnStartEnd", ""));
	}
	...
	private static final void loadVote()
	{
		...
		// Vote Manager
		L2NETWORK_ID = vote.getProperty("L2NetworkServerId", "null");
		L2TOPZONE_ID = vote.getProperty("L2TopZoneServerId", "null");
		L2TOPZONE_APIKEY = vote.getProperty("L2TopZoneApi", "null");
		L2HOPZONE_APIKEY = vote.getProperty("L2HopZoneApi", "null");
		VOTE_MANAGER_REWARD = vote.getProperty("VoteManagerReward", "null").split(";");
		...
		VOTES_FOR_REWARD_BRA = vote.getProperty("VotesRequiredForRewardBra", 100);
		VOTES_SYSTEM_INITIAL_DELAY_BRA = vote.getProperty("VotesSystemInitialDelayBra", 18);
		...
		VOTES_SITE_BRASIL_LINK_BRA = vote.getProperty("VotesSiteHopZoneLinkBra", "");
		...
		SERVERID_KEYTOPZONE = vote.getProperty("ServerIdTopzone", "l2damage");
		API_KEYTOPZONE = vote.getProperty("ApiKeyTopzone", "sdsafsag45s45as");
		
		APIKEY_HOPZONE = vote.getProperty("ApiKeyHopzone", "dsadasdasd");
		SERVERID_NETWORK = vote.getProperty("ServerIdNetwork", "11793");
		API_REWARD_ID = vote.getProperty("RewardID", 57);
		API_REWARD_COUNT = vote.getProperty("RewardCount", 500000);
		
		ONLINE_INTERVAL = vote.getProperty("MinutesDelayReward", 30);
		String AUTO_REWARD = vote.getProperty("OnlineReward", "57,100000000;");
		String[] auto_1 = AUTO_REWARD.split(";");
		for (String i : auto_1)
		{
			String[] auto_2 = i.split(",");
			ONLINE_REWARD.put(Integer.parseInt(auto_2[0]), Integer.parseInt(auto_2[1]));
		}
	...
	/**
	 * door1,door2... to the int[n] = [doorId1][doorId2]...
	 * @param line
	 * @return an array consisting of parsed items.
	 */
	private static final List<Integer> parseDoorsList(String line)
	{
		final String[] propertySplit = line.split(",");
		if (propertySplit.length == 0)
		...
		for (String value : propertySplit)
		{
			...
			{
				_log.warning("Config: Error parsing Door ID -> \"" + value + "\"");
				return new ArrayList<>();
			}
		}
	 ...
	 * @return an array consisting of parsed items.
	 */
	private static final Location parseLocation(String line)
	{
		final String[] propertySplit = line.split(",");
		if (propertySplit.length < 3 || propertySplit.length > 4)
			return null;
		...
		for (String value : propertySplit)
		{
			...
			{
				_log.warning("Config: Error parsing coordinate -> \"" + value + "\"");
				return null;
			}
		...
		{
			_log.warning("Config: Error parsing location -> size: \"" + result.length + "\"");
			return null;
		}
		
		final Location loc = result.length == 4 ? new Location(result[0], result[1], result[2], result[3]) : new Location(result[0], result[1], result[2]);
	...
	private static final void loadEvents()
	{
		...
		ALLOW_WEDDING = events.getProperty("AllowWedding", true);
	...
	private static final void loadServer()
	{
		...
		NEW_AI_MOVING_ATTACK_CHECK = server.getProperty("NewAIMovingAttackCheck", true);
		NEW_AI_MOVING_ATTACK_CHECK_RADIUS = server.getProperty("NewAIMovingAttackCheckRadius", 100);
	}
